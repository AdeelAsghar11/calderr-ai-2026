"""
vector_store.py — ChromaDB vector retrieval using SentenceTransformers (all-MiniLM-L6-v2).

Indexes all 55 paragraphs from FULL_CORPUS_PARAGRAPHS using all-MiniLM-L6-v2 embeddings.
...
class VectorRetriever:
    """ChromaDB-backed vector search over scaled 55-paragraph corpus."""
    ...
    def __init__(self, corpus: List[str] = FULL_CORPUS_PARAGRAPHS) -> None:
        ...
        self.collection_name = "project_6pb_corpus"
