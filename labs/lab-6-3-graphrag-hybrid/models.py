"""
models.py — Strongly typed Pydantic models for Lab 6.3 GraphRAG Hybrid Retrieval.
...
class QuestionRecord(BaseModel):
    ...
    expected_answer_keywords: List[str] = Field(
        description="Keywords that must appear in the retrieved context to verify retrieval correctness."
    )
